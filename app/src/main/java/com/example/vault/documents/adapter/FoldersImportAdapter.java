...
public class FoldersImportAdapter extends ArrayAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.imageAlbum.setImageResource(R.drawable.documenttt);
            ...
            viewHolder.checkbox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
                public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                    ((ImportAlbumEnt) FoldersImportAdapter.this.importAlbumEnts.get(((Integer) compoundButton.getTag()).intValue())).SetAlbumFileCheck(compoundButton.isChecked());
                }
            });
