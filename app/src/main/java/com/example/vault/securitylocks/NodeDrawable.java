...
public class NodeDrawable extends Drawable {
    ...
    public static int default_pattern_color = 0;
    ...
    static {
        int i = white;
        default_pattern_color = i;
        int i2 = default_pattern_color;
        DEFAULT_STATE_COLORS = new int[]{i2, i, seagreen, i, red, i2};
        DEFAULT_CIRCLE_COLORS = new int[]{DEFAULT_STATE_COLORS[0], i, i2};
    }
