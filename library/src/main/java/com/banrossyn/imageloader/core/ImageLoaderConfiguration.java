...
import com.banrossyn.imageloader.cache.disc.DiskCache;
...
import com.banrossyn.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.banrossyn.imageloader.core.assist.FlushedInputStream;
import com.banrossyn.imageloader.core.assist.ImageSize;
import com.banrossyn.imageloader.core.assist.QueueProcessingType;
import com.banrossyn.imageloader.core.decode.ImageDecoder;
import com.banrossyn.imageloader.core.download.ImageDownloader;
import com.banrossyn.imageloader.core.process.BitmapProcessor;
import com.banrossyn.imageloader.utils.L;
import com.banrossyn.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.banrossyn.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.banrossyn.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.banrossyn.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.banrossyn.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.banrossyn.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.banrossyn.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.banrossyn.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.banrossyn.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.banrossyn.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.banrossyn.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.banrossyn.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.banrossyn.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.banrossyn.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.banrossyn.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author rossyn (banrossyn[at]gmail[dot]com)
	 * @since 1.8.1
	 */
